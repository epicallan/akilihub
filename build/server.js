  ...
  var DataCenterPage = (function (_Component) {
    ...
    function DataCenterPage(props) {
      ...
      this.initalDataFetch = function () {
        ...
        var date = new Date('2016-02-24 12:00');
        if (date.getHours() < 3) {
        ...
        _this.rangeOfHoursToFetch(date);
        _this.currentDate = date;
        var unixStartTime = date.getTime() - _this.timeInterval * _this.hour;
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                      ...
                      _react2['default'].createElement(
                        'div',
                        { id: 'map', className: (0, _classnames2['default'])(_DataPageScss2['default'].chart, _DataPageScss2['default'].map), ref: 'map' },
                        ' '
                      )
                    ),
                    _react2['default'].createElement(
      ...
      value: function render() {
        return _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement('link', { rel: 'stylesheet', href: 'dc.min.css' }),
